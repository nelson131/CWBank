...
import me.nelson131.cwbank.commands.functions.*;
import me.nelson131.cwbank.commands.functions.staff.RealDeposit;
import me.nelson131.cwbank.commands.functions.staff.RealWithdraw;
...
public class CWBank {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        jda = JDABuilder.createDefault(getCFG("bot-token"))
                ...
                .addEventListeners(new WelcomeMessageCommand(), new CommandManager(), new CreateButtonEvent(), new Balance(), new Transfer(), new Delete(), new DeleteButtonEvent(), new Deposit(), new RealDeposit(), new Withdraw(), new RealWithdraw())
                .build();
